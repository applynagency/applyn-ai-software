from app.schemas.frontend_code_review import FrontendCodeReviewOutput


def _format_issues(output: FrontendCodeReviewOutput) -> list[str]:
...
def _format_recommendations(output: FrontendCodeReviewOutput) -> list[str]:
...
def output_to_markdown(output: FrontendCodeReviewOutput) -> str:
    """Convert structured Frontend Code Review output to a readable markdown document."""
    lines: list[str] = [
