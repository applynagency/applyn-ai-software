...
VALID_APPROVAL_STATUSES = {status.value for status in BackendApprovalStatus}


class BackendCodeReviewValidator:
    """Validates Backend Code Review output against review rules."""

    def validate(self, output: BackendCodeReviewOutput) -> ValidationResult:
        errors: list[str] = []
