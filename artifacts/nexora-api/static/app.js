...
function incidentSeverityBadge(severity) {
  ...
  const cls = { CRITICAL: "sev-critical", WARNING: "sev-warning", INFO: "sev-info" }[s] || "sev-info";
  return `<span class="sev-badge ${cls}">${escapeHtml(s)}</span>`;
}
...
function renderPage() {
  ...
  switch (state.route.page) {
    ...
    case "monitoring":
      return lazyIncidentsView("renderAlertsList");
    case "service-health":
      return renderServiceHealth();
    case "service-detail":
      return renderServiceDetail();
    case "deployment-safety":
      return renderDeploymentSafety();
    case "capacity":
    ...
    case "change-failure":
      return renderChangeFailure();
    case "runbooks":
      return renderRunbooks();
    case "copilot":
      return renderCopilot();
    case "reliability-dashboard":
      return renderReliabilityDashboard();
    case "reliability-maturity":
      return renderReliabilityMaturity();
    case "architecture":
      return renderArchitecture();
    case "executive-reports":
      return renderExecutiveReports();
    case "war-rooms":
